System.register(["./app.forms.questionBase", "@angular/core"], function (exports_1, context_1) {
    ...
    var app_forms_questionBase_1, core_1, InputText;
    return {
        setters: [
        ...
        execute: function () {
            ...
            InputText = __decorate([
                core_1.Component({
                    selector: 'app-forms-inputText'.toLowerCase(),
                    templateUrl: 'application/templates/app.forms.inputText.html'
                })
            ], InputText);
...
//# sourceMappingURL=app.forms.inputText.js.map