System.register(["./app.forms.questionBase", "@angular/core"], function (exports_1, context_1) {
    ...
    var app_forms_questionBase_1, core_1, Checkbox;
    return {
        setters: [
        ...
        execute: function () {
            ...
            Checkbox = __decorate([
                core_1.Component({
                    selector: 'app-forms-checkbox'.toLowerCase(),
                    templateUrl: 'application/templates/app.forms.checkbox.html'
                })
            ], Checkbox);
...
//# sourceMappingURL=app.forms.checkbox.js.map