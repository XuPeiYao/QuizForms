System.register(["./app.forms.questionBase", "@angular/core"], function (exports_1, context_1) {
    ...
    var app_forms_questionBase_1, core_1, Level;
    return {
        setters: [
        ...
        execute: function () {
            ...
            Level = __decorate([
                core_1.Component({
                    selector: 'app-forms-level'.toLowerCase(),
                    templateUrl: 'application/templates/app.forms.level.html'
                })
            ], Level);
...
//# sourceMappingURL=app.forms.level.js.map