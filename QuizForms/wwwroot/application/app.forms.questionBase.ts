...
export class QuestionBase {
    ...
    public static createAnsObject(q:QuizForms.Question,resultObj:any): any{
        var result = {};
        switch(q.type){
            case QuizForms.QuestionTypes.InputText:
            case QuizForms.QuestionTypes.InputNumber:
            case QuizForms.QuestionTypes.Level:
            case QuizForms.QuestionTypes.Dropdown://單一數據集合
                result[q.id.toString()] = resultObj[q.id];
                break;
            case QuizForms.QuestionTypes.Checkbox:
                ...
                break;
            case QuizForms.QuestionTypes.Radio://其他允許子項目控制項
                if(q.children.length){
                    var tempObj = {};
                    for(var i = 0 ; i < q.children.length ;i++){
                ...
                break;
            case QuizForms.QuestionTypes.CheckboxGroup:
                ...
                result[q.id.toString()] = tempAry;
                break;
            case QuizForms.QuestionTypes.RadioGroup://子系只能有Radio
