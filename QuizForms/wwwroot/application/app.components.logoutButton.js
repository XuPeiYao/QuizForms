System.register(["@angular/core", "./app.component.base"], function (exports_1, context_1) {
    ...
    var core_1, app_component_base_1, LogoutButtonComponent;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            LogoutButtonComponent = (function (_super) {
                __extends(LogoutButtonComponent, _super);
                ...
                LogoutButtonComponent.prototype.logout = function () {
                    return __awaiter(this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, QuizForms.User.getCurrentUser()];
                                case 1:
                                    if ((_a.sent()) == null) {
                                ...
                                case 2:
                                    _a.trys.push([2, 4, , 5]);
                                    return [4 /*yield*/, QuizForms.User.logout()];
                                case 3:
                                    _a.sent();
                                    location.href = "login.html" + location.search;
                                    return [3 /*break*/, 5];
            ...
            exports_1("LogoutButtonComponent", LogoutButtonComponent);
        }
    };
});
//# sourceMappingURL=app.components.logoutButton.js.map